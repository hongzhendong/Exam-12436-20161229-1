...
public class Film {
	...
	public Film(int film_id, String title, String description, Date release_year, int language_id,
			int original_language_id, int rental_duration, int rental_rate, int length, int replacement_cost,
